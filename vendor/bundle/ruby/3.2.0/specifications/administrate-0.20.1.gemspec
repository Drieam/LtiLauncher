...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<actionpack>.freeze, [">= 6.0", "< 8.0"])
  s.add_runtime_dependency(%q<actionview>.freeze, [">= 6.0", "< 8.0"])
  s.add_runtime_dependency(%q<activerecord>.freeze, [">= 6.0", "< 8.0"])
  s.add_runtime_dependency(%q<jquery-rails>.freeze, ["~> 4.6.0"])
